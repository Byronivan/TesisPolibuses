...
import { RegistroPerAdmComponent } from './registro-per-adm.component';




describe('RegistroPerAdmComponent', () => {
    let component: RegistroPerAdmComponent;
    let fixture: ComponentFixture<RegistroPerAdmComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [RegistroPerAdmComponent],
            imports: [
                MaterialModule,
                FormsModule,
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(RegistroPerAdmComponent);
    ...
    it('Debería validar que el email es requerido y válido', () => {
        ...
        email.setValue("prueba@epn.edu.ec");
        errors = email.errors || {};
        expect(errors['required']).toBeFalsy();
